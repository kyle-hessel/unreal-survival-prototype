...
UNREALROOTPATH = /home/hesselwerks/software/Unreal/UnrealEngine
GAMEPROJECTFILE =/home/hesselwerks/projects/unreal/Campfires/campfires 5.1/CampfiresTest.uproject

TARGETS = \
	CampfiresTest-Linux-Debug  \
	CampfiresTest-Linux-DebugGame  \
	CampfiresTest-Linux-Test  \
	CampfiresTest-Linux-Shipping  \
	CampfiresTest \
	CampfiresTestEditor-Linux-Debug  \
	CampfiresTestEditor-Linux-DebugGame  \
	CampfiresTestEditor-Linux-Test  \
...
CampfiresTest-Linux-Debug:
	 $(PROJECTBUILD) CampfiresTest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CampfiresTest-Linux-DebugGame:
	 $(PROJECTBUILD) CampfiresTest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CampfiresTest-Linux-Test:
	 $(PROJECTBUILD) CampfiresTest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
CampfiresTestEditor-Linux-Debug:
	 $(PROJECTBUILD) CampfiresTestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CampfiresTestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CampfiresTestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CampfiresTestEditor-Linux-Test:
	 $(PROJECTBUILD) CampfiresTestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
